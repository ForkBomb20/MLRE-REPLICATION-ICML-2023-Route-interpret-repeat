...
parser.add_argument('--epochs', type=int, default=100, help='epoch size for training the explainer - g')
...
def main():
    ...
    print(f"Training G for concept completeness: {args.dataset}")
    if args.per_iter_completeness == "n":
        cal_completeness_score(args)
    elif args.per_iter_completeness == "y":
        cal_completeness_score_per_iter(args)
